...
INTERFACE
  ...
  PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);{считывает мес€ц из файла}
  PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month);{выводит мес€ц в файл}
IMPLEMENTATION
  PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);
  {»нициализируем переменную Mo в зависимости от строки в файле}
  VAR
    Ch1, Ch2, Ch3: CHAR;
  BEGIN{ReadMonth}
    Mo := NoMonth;
  ...
  {¬ыводит строку в файл в зависимости от значени€ переменной Mo}
  BEGIN {WriteMonth}
